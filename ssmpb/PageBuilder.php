...
class PageBuilder extends Controller
{
            ...
            if (have_rows('sections')) {
                ...
                while (have_rows('sections')) {
                    ...
                    switch ($layout) {
                        ...
                        case 'columns':
                            $this->getTemplatePart( $this->templates_dir . '/columns-section.php', $tpl_args);
                            $cols_cb_i++;
                            break;
                        case 'related_content':
                            $this->getTemplatePart( $this->templates_dir . '/related-content-section.php', $tpl_args);
                            break;
                        case 'block_grid':
                            $this->getTemplatePart( $this->templates_dir . '/block-grid-section.php', $tpl_args);
                            break;
                    }
                }
            }
    ...
    //the_columns()
    protected function build( $context = 'section', $tpl_args )
    {
    ...
    protected function getModules( $tpl_args )
    {
        ...
        while ( have_rows('components') ) {
            ...
            switch ( $layout ) {
                ...
                break;
                case 'text_editor' :
                    $this->getTemplatePart( $this->modules_dir . '/text-editor.php', $tpl_args);
                break;
                case 'image' :
    ...
    //get_inline_styles()
    protected function getInlineStyles( $context = 'section' )
    {
        $image = '';
        $style = 'test';
    ...
    //section_id_classes()
    protected function getSectionClasses( $classes = '' )
    {
        ...
        if ( $classes != NULL ) {
          $classes = SSMH::sanitize_html_classes($classes);
          $section_id_classes .= ' ' . $classes;
        }
    ...
    protected function getVideoBackground( $context = 'section' )
    {
    ...
    protected function getComponentClasses()
    {
        ...
        if ( $c_classes != NULL ) {
            $c_classes = SSMH::sanitize_html_classes($c_classes);
