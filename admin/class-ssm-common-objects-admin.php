 ...
 * @subpackage Ssm_Common_Objects/admin
 */
 ...
 */
class Ssm_Common_Objects_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/ssm-common-objects-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/ssm-common-objects-admin.js', array( 'jquery' ), $this->version, false );
